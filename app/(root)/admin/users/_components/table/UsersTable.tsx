        ...
        <>
            <div className='w-full h-auto p-5 flex justify-between items-center '>
                ...
                <div className='w-fit flex justify-between items-center gap-2 px-5'>
                    ...
                    <Button className="w-fit bg-[#30a85f] text-[#fff] border-2 border-[#dcdee6] flex justify-between items-center gap-2 px-5 hover:bg-[#30a85f] hover:text-[#fff]"><span className="text-[14px] font-noraml">New User</span></Button>
                </div>
            </div>
            <Table>
                <TableHeader>
                            ...
                            <TableCell colSpan={columns.length} className="h-24 text-center">
                                <div>
                                    ...
                                    <p className="text-md text-center text-gray-200 font-medium">
                                        Appears you have not added any user yet, go ahead and add <br /> them now.
                                    </p>
                                </div>
                                <div className="w-full flex justify-center items-center">
                                    <Button className="w-fit bg-[#30a85f] text-[#fff] border-2 border-[#dcdee6] flex justify-between items-center gap-2 px-5 hover:bg-[#30a85f] hover:text-[#fff]"><span className="text-[14px] font-noraml">Add User</span></Button>
                                </div>
                            </TableCell>
                        </TableRow>
                    )}
