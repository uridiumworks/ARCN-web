...
const NarisAction = ({narisData}: any) => {
  const [dialog, setDialog] = useState(0);
  const router = useRouter();
  return (
    <Dialog>
      {dialog === 1 && <DeleteAction id={narisData?.narisId}/>}
      <DropdownMenu modal={false}>
        ...
        >
          <DropdownMenuItem
            ...
            onClick={() => router.push(`/admin/research/naris/${narisData?.narisId}`)}
          >
