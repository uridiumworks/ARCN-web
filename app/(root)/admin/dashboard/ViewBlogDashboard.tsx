...
const ViewBlogDashboard = () => {
    ...
    const { loading: loadingDashboard, dashboard, error: errorDashboard } = useDashboardData(token);
    ...
    if (loadingDashboard || loadingBlogs) return <p>Loading....</p>;
    if (errorDashboard || errorBlogs) return <p>Error loading data</p>;
