...
const SettingsPage = () => {
  ...
  return (
    ...
    <div className='w-full min-h-[70vh]'>
        <div>
            <p className='text-[#374151] text-[24px] leading-[30px] font-bold font-[Montserrat]'>Settings</p>
            <p className='text-[#374151] text-[18px] leading-[32.4px] font-normal font-[Montserrat]'>Manage yur account here</p>
        </div>
                    ...
                    className={cn(
                      "rounded-none px-0 py-6 text-gray-500 bg-inherit hover:border-b-[3px] hover:border-[#30a85f] hover:bg-inherit transition-all ease-in-out delay-150",
                      {
                        "border-b-[3px] border-[#30a85f] text-primary-400 font-semibold":
                          data?.name === "Reset Password" && tab === data?.tab,
                      },
                      {
                        "border-b-[3px] border-[#30a85f] text-primary-400 font-semibold":
                          data?.name === "Preferences" && tab === data?.tab,
                      }
                    )}
                  >
                    {data?.name}
