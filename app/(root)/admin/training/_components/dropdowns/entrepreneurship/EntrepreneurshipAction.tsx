...
const EntrepreneurshipAction = ({entrepreneurshipData}: any) => {
  const [dialog, setDialog] = useState(0);
  const router = useRouter();
  return (
    <Dialog>
      {dialog === 1 && <DeleteAction id={entrepreneurshipData?.entrepreneurshipId}/>}
      <DropdownMenu modal={false}>
        ...
        >
          <DropdownMenuItem
            ...
            onClick={() => router.push(`/admin/training/entrepreneurship/${entrepreneurshipData?.entrepreneurshipId}`)}
          >
...
export default EntrepreneurshipAction