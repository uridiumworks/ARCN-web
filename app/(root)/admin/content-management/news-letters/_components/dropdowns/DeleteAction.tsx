      ...
      <DialogHeader>
        ...
        Are you sure you want to delete this post? This action cannot be undone.
            ...
            <div className="grid grid-cols-2 mt-8 gap-3">
              ...
              <Button disabled={loading} type='button' onClick={() => deleteNewsLetter(id, closeDeleteDialogRef)} className="bg-red-600 text-white hover:bg-red-600 hover:text-white">
