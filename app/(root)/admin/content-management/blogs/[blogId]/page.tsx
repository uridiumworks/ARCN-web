            ...
            <div className='w-full min-h-[70vh]'>
                <div>
                    <div className='w-full flex justify-end items-center'>
                        <Button onClick={() => router.push(`/admin/content-management/blogs`)} className='bg-white text-black border-2 border-[#dcdee6] hover:bg-white hover:text-black'>Go back</Button>
                    </div>
                    <Form {...form}>
