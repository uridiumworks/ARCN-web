...
import { ContentManagementBlogscolumns, Journalscolumns } from '../blogs/_components/table/column';
    ...
    <div className='w-full min-h-[70vh]'>
       ...
       {createNewJournal ? <NewJournalForm setCreateNewJournal={setCreateNewJournal} /> : <>
        ...
        <div className='w-full min-h-[70vh] bg-white rounded-md mt-5'>
            <JournalTable columns={Journalscolumns} data={journalsArray ?? []} setCreateNewJournal={setCreateNewJournal}/>
        </div>
        </>}
    </div>
</div>
