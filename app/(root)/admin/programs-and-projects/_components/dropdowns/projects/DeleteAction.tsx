...
const {isDeleting,deleteProjects} = useProjectsContext()
    ...
    <DialogHeader>
          ...
          <DialogDescription className="py-4">
            ...
            <div className="grid grid-cols-2 mt-8 gap-3">
              ...
              <Button disabled={isDeleting} type='button' onClick={() => deleteProjects(id, closeDeleteDialogRef)} className="bg-red-600 text-white hover:bg-red-600 hover:text-white">
