...
const ServiceDepartmentDetails = () => {
    return (
        <section className="w-full">
            <div className="h-[380px] w-full bg-[#FCF8C6]">
                <div className="w-[1250px] ml-32 space-y-8 pt-16">
                    <h1 className="text-[40px] font-semibold">Administration Department</h1>
                    <p className="text-lg">The Administrative Department as the secretariat of ARCN covers broad areas of the council's<br /> 
                    mandate as well as the NARS. It is responsible for managing and overseeing various administrative<br /> activities for the smooth running of the council.</p>
                </div>
            ...
            <div className="w-[1250px] mx-auto py-5">
                ...
                <div className="space-y-5">
                    <h1 className="text-[38px] font-semibold">Administration Department Divisions</h1>
                    
                    <div className="space-y-7">
                        {AdminDepartmentData?.map(({description, descriptionList, title}, index) => {
                            return (
                                <div key={index} className={cn(index === 0 && "bg-[#FFC74E] text-black", index === 1 && "bg-[#2E7636] text-white", index === 2 && 'bg-black text-white', index === 3 && 'bg-[#75CDFD] text-black', index === 4 && 'bg-[#011843] text-white', " rounded-[16.17px] py-6 px-7 space-y-4 w-11/12")}>
