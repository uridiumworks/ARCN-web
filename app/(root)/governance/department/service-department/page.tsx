    ...
    return (
        <section className="w-[1250px] py-4 mx-auto">
            ...
            <div className="py-10 space-y-10">
                <div className="">
                    <h1 className="text-[40px] font-bold text-[#1B222B]">Service Department</h1>
                ...
                <div className='md:grid-cols-2 w-full py-6 px-5 rounded-2xl bg-[#F6E8414D] mx-auto'>
                    <div className="md:py-5 md:px-8 space-y-5">
                        <div>
                            ...
                            <p className="text-base text-gray mt-4 py-3">The Administrative Department as the secretariat of ARCN covers broad areas of the council&rsquo;s mandate as well as the NARS. It<br /> is responsible for managing and overseeing various administrative activities for the smooth running of the council.</p>
                        </div>

                        <div className='grid grid-cols-4 gap-5 w-full h-[140px] mb-10 font-bold text-xl'>
                            <div className='bg-[#FFC74E] border p-8 flex items-center  rounded-[16.17px] text-left'>
                                <h1 className="">Transport Unit</h1>
                            </div>

                            <div className='bg-[#2E7636] p-8 border flex items-center rounded-[16.17px] text-left'>
                                <h1 className="text-white">Records & Registry Unit</h1>
                            </div>

                            <div className='bg-black p-6 border flex items-center rounded-[16.17px] text-left'>
                                <h1 className="text-white mt-1">Maintenance Unit</h1>
                            </div>

                            <div className='bg-[#75CDFD] border flex items-center p-6 rounded-[16.17px] text-left'>
