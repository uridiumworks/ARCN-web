  ...
  return (
    <section className="w-full">
      <HeaderComp
        ...
        description={
          <>
            Plant resource department is organized into divisions which are
            framed to monitor production of solutions in research
            ...
            <BreadcrumbList>
              ...
              <BreadcrumbItem>
                <BreadcrumbPage className="text-[#30A85F] font-medium">
                  Plant Resources Department
                </BreadcrumbPage>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>

          <FunctionalComp title="Research Focus" FunctionData={FunctionData} />
