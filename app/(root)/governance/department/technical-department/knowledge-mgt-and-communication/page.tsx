  ...
  return (
    <section className="w-full">
      <HeaderComp
        ...
        description={
          <>
            The Knowledge Management and Communication Department enhances
            learning, innovation, and collaboration within NARS
            <br className="hidden md:block" /> by developing systems for
            information sharing, research dissemination, and database
            management. It supports agricultural research
            <br className="hidden md:block" />
            through a national science library, publications, and global
            visibility efforts while promoting communication among scientists
            and stakeholders.
          </>
        }
      />
