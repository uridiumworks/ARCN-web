...
const TechnicalDepartmentData = [
    {
        ...
        description: 'The Extension and Socio-economics Department of the Agricultural Research Council of Nigeria (ARCN) is charged with the management and supervision of research and extension activities of ARCN, NARIs and FCAs on behalf of the Council Management',
        descriptionList: [
    ...
    },
    {
        ...
        description: 'The mandate of Livestock department in ARCN is to coordinate, supervise and regulate Livestock research and training activities in the National Agricultural Research Institutes (NARIs) and Federal Colleges of Agriculture (FCAs).',
        descriptionList: [
    ...
    },
    {
        ...
        description: 'Plannig reseaech and statistics coordinate and review policies, priorities and strategies of agricultural research, training and extension for the council, National Agricultural Research Institutes (NARIs) and Federal College of Agriculture (FCAs) under the purview of the Council.',
        descriptionList: [
        ...
        <section className="w-full md:w-[1250px] px-2.5 py-4 mx-auto">
            <Breadcrumb>
                <BreadcrumbList>
                    ...
                    <BreadcrumbItem>
                        <BreadcrumbPage className="text-[#30A85F] font-medium">Technical Department</BreadcrumbPage>
                    </BreadcrumbItem>
                </BreadcrumbList>
            </Breadcrumb>
                    ...
                    return (
                        <div key={index} className={cn(index === 0 && 'bg-[#F6E8414D]', index === 1 && 'bg-[#2A59FE4D]', index === 2 && 'bg-[#87C12F4D]', index === 3 && 'bg-[#FF91A04D]', index === 4 && 'bg-[#013B434D]', index === 5 && 'bg-[#BEE5ED4D]', 'md:grid-cols-2 w-full py-6 px-5 rounded-2xl  mx-auto')}>
                            <div className="md:py-5 md:px-8 space-y-5">
                                <div>
                                    <h1 className="lg:text-[32px] text-xl text-black text-bold mb-5 font-bold">{title}</h1>
