  ...
  return (
    <section className="w-full">
      <HeaderComp
        ...
        description={
          <>
            Plannig research and statistics coordinate and review policies,
            priorities and strategies of agricultural research, training and
            <br className="hidden md:block" />
            extension for the council, National Agricultural Research Institutes
            (NARIs) and Federal College of Agriculture (FCAs)
            <br className="hidden md:block" />
      ...
      <CustomContainer>
        <div className="w-full px-2.5 py-5">
          ...
          <FunctionalComp title="Mandate" FunctionData={FunctionData} />
