...
const Department = ({setTab}:any) => {
    return (
        <section className='px-10 py-24'>
            ...
            <div className='mb-8 grid grid-cols-1 md:grid-cols-2 gap-60 lg:w-[1200px] pt-1.5 pl-20 rounded-[20px] bg-[#30A85F] mx-auto'>
                <div className='space-y-8'>
                    <div className='pt-5'>
                        <h1 className="text-[32px] text-white text-bold mt-5 mb-5 font-bold">Service Department</h1>
            ...
            <div className=' mt-8 grid grid-cols-1 md:grid-cols-2 gap-60 lg:w-[1200px] pt-5 pl-20 rounded-[20px] bg-[#FFC74E] mx-auto'>
                <div className='space-y-8'>
                    <div className='space-y-2'>
                        <h1 className="text-[32px] text-black text-bold mt-5 mb-5 font-bold">Technical Department</h1>
