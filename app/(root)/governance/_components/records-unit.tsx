...
const AdministrationDepartment1 = () => {
    return (
        ...
        <div className=' mb-24 mt-10 md:grid-cols-2 w-full lg:w-[90%] pt-10 rounded-2xl bg-[#F6E8414D] mx-auto'>
            ...
            <div className='flex lg:flex-row flex-col lg:w-[90%] lg:h-[50%] w-full p-8 gap-4 lg:space-x-7 lg:ml-14  '>
                <div className='bg-[#FFC74E] border p-7 rounded-[16.17px] text-left lg:w-[45%]'>
