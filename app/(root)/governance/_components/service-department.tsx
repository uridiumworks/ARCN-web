        ...
        <section className="px-10 py-20">
            ...
            <div className=' mb-8 mt-10 md:grid-cols-2 lg:w-[1400px] pt-10 rounded-2xl bg-[#F6E8414D] mx-auto'>
                <div className="py-10 px-20">
                    <div>
                        <h1 className="text-[32px] text-black text-bold mb-5 font-bold">Administration Department</h1>
                    ...
                    <div className='flex h-[288.71px] p-3 gap-4 space-x-7 '>
                        ...
                        <div className='bg-[#2E7636] p-8 border rounded-lg text-left w-[400px]'>
                        ...
                        <div className='bg-[#75CDFD] border p-6 rounded-lg text-left w-[400px]'>
