...
const ServiceDepartment = () => {
    return (
        <section className="w-fit px-10 py-20">
            ...
            <div className='mb-8 mt-10 md:grid-cols-2 w-full lg:w-[100%] pt-10 rounded-2xl bg-[#F6E8414D] mx-auto'>
                <div className="md:py-5 md:px-8 p-5">
                    <div>
                    ...
                    <div className='flex flex-col lg:flex-row w-full h-full lg:h-[50%] gap-4'>
                        <div className='bg-[#FFC74E] border p-8 lg:w-[45%] rounded-[16.17px] text-left '>
