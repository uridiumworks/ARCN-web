...
const GovernanceMotto = () => {
    return (
        <div className="w-full font-montserrat bg-black text-center flex flex-col justify-center items-center h-[487px] px-4 md:px-8">
            <h1 className="text-3xl sm:text-5xl md:text-[65px] font-bold text-white">
                Governance
            </h1>
