        ...
        <CustomContainer>
          <div className=" flex flex-col gap-8">
            ...
            <div className="grid grid-cols-engagement-res gap-8">
              ...
              <div className="flex items-start gap-2.5">
              <div><FarmerIcon2 className="scale-[.55]" /></div>  
                <div className="flex flex-col gap-4">
                  <h3 className="text-2xl sm:text-3xl font-medium text-[#1B222B]">
              ...
              <div className="flex items-start gap-2.5">
              <div><TractorIcon2 className="scale-[.55]" /></div>  
                <div className="flex flex-col gap-4">
                  <h3 className="text-2xl sm:text-3xl font-medium text-[#1B222B]">
        ...
        <div className="flex flex-col gap-6 border border-[#E7E7E7] bg-[#FCFCFC] rounded-2xl px-3 py-4">
          ...
          <div className="flex flex-col gap-4">
            <p className="text-sm sm:text-lg text-[#171616]">
              NRCRI’s efforts align with Sustainable Development Goals (SDGs) by
              addressing hunger (SDG 2), promoting sustainable agriculture (SDG
              12), and fostering partnerships for development (SDG 17).
            </p>
            <p>
              With its rich history, strategic initiatives, and unwavering
              commitment to agricultural development, NRCRI continues to be a
              vital player in enhancing Nigeria&apos;s agricultural productivity
              and ensuring sustainable national food security.
            </p>
          </div>
        </div>
      </div>
