        ...
        <main>
            <div>
                <div className="px-20 py-10 space-y-8">
                    ...
                    <p className="font-medium text-base"><span className="text-[15.88px] font-medium text-[#2D7636]">ARCN Research Institutes</span> are non-profit research organizations conducting innovative <br />research. Home to more than 9,000 scientists, researchers, technicians and staff, the
                    <br />Centers work to transform food, land and water systems in a climate crisis. Click on a
                ...
                <div className="lg:w-[1200px] mx-auto space-y-5 pb-8">
                    <div className="grid lg:grid-cols-3 gap-8 w-full lg:w-[1/2]">
                        <div className="border-[0.59px] space-y-4 py-1.5 px-3 bg-[#FFFFFF] text-black rounded-lg lg:h-[276px] ">
                        ...
                        <div className="border-[0.59px] space-y-8 py-1.5 px-3 bg-[#FFFFFF] text-black rounded-lg lg:h-[276px] ">
                            ...
                            <div>
                                <h1 className="font-semibold text-sm">Cocoa Research Institute of Nigeria</h1>
                                <p  className="font-normal grid grid-cols-1 gap-3.5 text-[13px]">
                                Rubber research institute of Nigeria is the only Federal Government agency in Nigeria that has the mandate to conduct research and development on rubber and other latex producing plants of economic importance. 
                                </p>
                            </div>
                        ...
                        <div className="border-[0.59px] space-y-4 py-1.5 px-3 bg-[#FFFFFF] text-black rounded-lg lg:h-[276px] ">
                            ...
                            <h1 className="font-semibold text-sm">National Horticultural Research Institute</h1>
                            <p  className="font-normal grid grid-cols-1 gap-3.5 text-[13px]">
                    ...
                    <div className="grid lg:grid-cols-3 gap-8 w-full lg:w-[1/2]">
                        ...
                        <div className="border-[0.59px] space-y-4 py-1.5 px-3 bg-[#FFFFFF] text-black rounded-lg lg:h-[276px] ">
                            <div className="space-y-2 items-center flex gap-2">
                                <Image src="/Image/Icons/Animals.png" alt="cocoa" width={42} height={42} />
                            </div>
                            <h1 className="font-semibold text-sm">Cocoa Research Institute of Nigeria</h1>
                            <p  className="font-normal grid grid-cols-1 gap-3.5 text-[13px]">
                            Cocoa Research Institute of Nigeria (CRIN) was established in
                    ...
                    <div className="grid lg:grid-cols-3 gap-8 w-full lg:w-[1/2]">
                        <div className="border-[0.59px] space-y-4 py-1.5 px-3 bg-[#FFFFFF] text-black rounded-lg lg:h-[276px] ">
                            <div className="space-y-2 items-center flex gap-2">
                                <Image src="/Image/Icons/Fishes.png" alt="Roots" width={42} height={42} />
                            </div>
                            <h1 className="font-semibold text-sm">Cocoa Research Institute of Nigeria</h1>
                            <p  className="font-normal grid grid-cols-1 gap-3.5 text-[13px]">
                            Cocoa Research Institute of Nigeria (CRIN) was established in
                        ...
                        <div className="border-[0.59px] space-y-5 py-1.5 px-3 bg-[#FFFFFF] text-black rounded-lg lg:h-[276px] ">
                            <div className="space-y-2 items-center flex gap-2">
                                <Image src="/Image/Icons/Liason.png" alt="Cereals" width={42} height={42} />
                            </div>
                            <h1 className="font-semibold text-sm">Cocoa Research Institute of Nigeria</h1>
                            <p  className="font-normal grid grid-cols-1 gap-3.5 text-[13px]">
                            Rubber research institute of Nigeria is the only Federal Government agency in Nigeria that has the mandate to conduct research and development on rubber and other latex producing plants of economic importance. 
                        ...
                        <div className="border-[0.59px] space-y-4 py-1.5 px-3 bg-[#FFFFFF] text-black rounded-lg lg:h-[276px] ">
                            <div className="space-y-2 items-center flex gap-2">
                                <Image src="/Image/Icons/Veterinary.png" alt="cocoa" width={42} height={42} />
                            </div>
                            <h1 className="font-semibold text-sm">Cocoa Research Institute of Nigeria</h1>
                            <p  className="font-normal grid grid-cols-1 gap-3.5 text-[13px]">
                            Cocoa Research Institute of Nigeria (CRIN) was established in
                    ...
                    <div className="grid lg:grid-cols-3 gap-8 w-full lg:w-[1/2]">
                        <div className="border-[0.59px] space-y-4 py-1.5 px-3 bg-[#FFFFFF] text-black rounded-lg lg:h-[276px] ">
                            <div className="space-y-2 items-center flex gap-2">
                                <Image src="/Image/Icons/Marine.png" alt="Roots" width={42} height={42} />
                            </div>
                            <h1 className="font-semibold text-sm">Cocoa Research Institute of Nigeria</h1>
                            <p  className="font-normal grid grid-cols-1 gap-3.5 text-[13px]">
                            Cocoa Research Institute of Nigeria (CRIN) was established in
                        ...
                        <div className="border-[0.59px] space-y-5 py-1.5 px-3 bg-[#FFFFFF] text-black rounded-lg lg:h-[276px] ">
                            <div className="space-y-2 items-center flex gap-2">
                                <Image src="/Image/Icons/OilPalm .png" alt="Cereals" width={42} height={42} />
                            </div>
                            <h1 className="font-semibold text-sm">Cocoa Research Institute of Nigeria</h1>
                            <p  className="font-normal grid grid-cols-1 gap-3.5 text-[13px]">
                            Rubber research institute of Nigeria is the only Federal Government agency in Nigeria that has the mandate to conduct research and development on rubber and other latex producing plants of economic importance. 
                        ...
                        <div className="border-[0.59px] space-y-4 py-1.5 px-3 bg-[#FFFFFF] text-black rounded-lg lg:h-[276px] ">
                            <div className="space-y-2 items-center flex gap-2">
                                <Image src="/Image/Icons/Products.png" alt="cocoa" width={42} height={42} />
                            </div>
                            <h1 className="font-semibold text-sm">Cocoa Research Institute of Nigeria</h1>
                            <p  className="font-normal grid grid-cols-1 gap-3.5 text-[13px]">
                            Cocoa Research Institute of Nigeria (CRIN) was established in
                    ...
                    <div className="grid lg:grid-cols-3 gap-8 w-full lg:w-[1/2]">
                        <div className="border-[0.59px] space-y-4 py-1.5 px-3 bg-[#FFFFFF] text-black rounded-lg lg:h-[276px] ">
                            <div className="space-y-2 items-center flex gap-2">
                                <Image src="/Image/Icons/Training.png" alt="Roots" width={42} height={42} />
                            </div>
                            <h1 className="font-semibold text-sm">Cocoa Research Institute of Nigeria</h1>
                            <p  className="font-normal grid grid-cols-1 gap-3.5 text-[13px]">
                            Cocoa Research Institute of Nigeria (CRIN) was established in
                        ...
                        <div className="border-[0.59px] space-y-5 py-1.5 px-3 bg-[#FFFFFF] text-black rounded-lg lg:h-[276px] ">
                            <div className="space-y-2 items-center flex gap-2">
                                <Image src="/Image/Icons/Agricultural.png" alt="Cereals" width={42} height={42} />
                            </div>
                            <h1 className="font-semibold text-sm">Cocoa Research Institute of Nigeria</h1>
                            <p  className="font-normal grid grid-cols-1 gap-3.5 text-[13px]">
                            Rubber research institute of Nigeria is the only Federal Government agency in Nigeria that has the mandate to conduct research and development on rubber and other latex producing plants of economic importance. 
                        ...
                        <div className="border-[0.59px] space-y-4 py-1.5 px-3 bg-[#FFFFFF] text-black rounded-lg lg:h-[276px] ">
                            <div className="space-y-2 items-center flex gap-2">
                                <Image src="/Image/Icons/LakeChad.png" alt="cocoa" width={42} height={42} />
                            </div>
                            <h1 className="font-semibold text-sm">Cocoa Research Institute of Nigeria</h1>
                            <p  className="font-normal grid grid-cols-1 gap-3.5 text-[13px]">
                            Cocoa Research Institute of Nigeria (CRIN) was established in
