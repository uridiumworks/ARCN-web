            ...
            <div className="grid grid-cols-about-mandate-res gap-10">
              ...
              <h3 className="font-medium text-xl sm:text-2xl sm:leading-[1.61375rem] text-[#131517]">
                ...
                <p  className="font-normal text-sm sm:text-lg sm:leading-[1.61375rem] text-[#64728F] hidden lg:block ">
                  To create a Centre with the capacity to <br /> mechanize
                  Nigeria&apos;s agriculture by <br /> encouraging home-grown
                  mechanization <br /> technologies and drastically reducing or <br />
                  eliminating importation of agricultural <br /> machines and
                  equipment.
                </p>
              ...
              <div className="flex flex-col gap-3 rounded-xl py-5 px-7 border-[1.08px] border-[#E8E8E8] bg-white">
                ...
                <p className="font-normal text-sm sm:text-lg sm:leading-[1.61375rem] text-[#64728F] hidden lg:block ">
                  To standardize developed agricultural <br /> mechanization
                  technologies to ensure <br /> efficiency, reliability, quality, and
                  consistency, <br /> while making available through research and
                  development, mechanization technologies <br /> across various value
                  chains.
                </p>
            ...
            <div className="grid grid-cols-[100%] rounded-xl py-5 px-7 border-[1.08px] border-[#E8E8E8] bg-white">
              <div className="flex flex-col gap-3">
                ...
                <p className="font-normal text-sm sm:text-lg sm:leading-[1.61375rem] text-[#64728F] hidden lg:block ">
                  ...
                  transformation of Nigeria&apos;s <br /> agricultural sector through
                  adaptive and innovative research and development activities, <br />
                  focusing on indigenous machine development, standardization,
                  and technology <br /> dissemination.
                </p>
