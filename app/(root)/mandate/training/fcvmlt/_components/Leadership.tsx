            ...
            <div className="flex flex-col items-start gap-6">
              <div className="flex items-center gap-3">
                ...
                <p className="text-sm sm:text-lg font-normal">
                  {" "}
                  <span className="font-bold">Provost/CEO:</span> Dr. Chukwu
                  Otuh Okoh Chukwu, PhD, FAMLSN
                </p>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <p className="text-sm sm:text-lg font-normal">
                  {" "}
                  <span className="font-bold">Registrar:</span> Umar Baba-Aliyu
                </p>
              </div>
            </div>
          </div>
