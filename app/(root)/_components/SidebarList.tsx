          ...
          return (
            <div key={index++}>
              <Link
                ...
                href={link?.url.includes("content-management") ? "" : link?.url}
              >
                <div
                  className={cn(
                ...
                >
                  ...
                  >
                    {SideLinkDropdown?.map((link: any, index: number) => {
                      ...
                      const currentRouteLinkResult = currentRoute
                        .split("/")
                        .pop(); // This will give you "blogs"
                      const active =
                        linkResult === currentRouteLinkResult ? true : false;
                      return (
