import { ContentManagementIcon, DashboardIcon, EventIcon, HealthIcon, LogoutIcon, MarketResearchIcon, SettingsIcon, UserIcon } from "@/assets/icons";
...
export const BottomSideLink: Array<SideLinkType> = [
      ...
      name: "Logout",
      url: "/",
      icon: <LogoutIcon className="scale-95 text-white" />,
    },
