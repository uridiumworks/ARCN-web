        ...
        <section className="min-h-screen">
            <div className="flex flex-col justify-center gap-7 lg:w-10/12 md:mx-auto"> 
                ...
                <div className="flex flex-col text-center md:px-14 space-y-7">
                    <h1 className="font-bold text-[#111827] text-3xl md:text-4xl">Closing the gender gap and enhancing opportunities for youth in food, land, and water systems.</h1>
                    <p className="font-medium text-sm md:px-28 text-[#3F4654]">More than 85% of the world&apos;s 1.2 billion youth live in low- and middle-income countries, where many face limited opportunities for employment or entrepreneurship.</p>
                </div>
                ...
                <div className="md:w-9/12 py-6 px-4 mx-auto space-y-9">
                    ...
                    <p className="text-[#111827] font-normal text-sm">Lorem ipsum dolor sit amet consectetur. Viverra at magna placerat mattis. Et nullam hac at felis eu vulputate in a aenean. Pretium nibh ac sed viverra ac urna interdum. Lobortis bibendum enim scelerisque id. Consectetur eget neque luctus magna in elementum. Lacus amet sed arcu in elementum.</p>
                    <h1 className="text-[#111827] font-bold text-base">Lorem ipsum dolor sit amet consectetur. Quis faucibus netus.</h1>
