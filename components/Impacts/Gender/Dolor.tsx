...
const Dolor = () => {
    return ( 
        <section className="min-h-screen">
            <div className="flex flex-col justify-center gap-7 w-7/12 mx-auto "> 
                <div className="flex flex-col justify-center py-10 ">
                    <button type="button" className="text-sm font-semibold text-[#3F4654] border-[#0B3D7929] rounded-md shadow-inner w-2/12 mx-auto  py-2 px-4">IMPACT</button>
                </div>
                <div className="flex flex-col text-center space-y-7">
                    <h1 className="font-bold text-[#111827] text-5xl">Closing the gender gap and enhancing opportunities for youth in food, land, and water systems.</h1>
                    <p className="font-medium text-xl text-[#3F4654]">More than 85% of the world&apos;s 1.2 billion youth live in low- and middle-income countries, where many face limited opportunities for employment or entrepreneurship.</p>
                </div>
                ...
                <div className="w-8/12 py-6 mx-auto space-y-9">
