...
const Dolor = () => {
    return ( 
        <section className="min-h-screen">
            <div className="flex flex-col justify-center gap-7 md:w-10/12 md:mx-auto"> 
                ...
                <div className="flex flex-col text-center md:px-12 space-y-7">
                    <h1 className="font-bold text-[#111827] text-lg md:text-5xl">Closing the gender gap and enhancing opportunities for youth in food, land, and water systems.</h1>
