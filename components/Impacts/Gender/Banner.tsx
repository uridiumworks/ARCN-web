...
const Banner = () => {
    return ( 
        <section>
            <div className="flex flex-row lg:gap-40 md:h-[270px] lg:px-28 py-8 bg-[#B3404B]">
                <div className="text-white space-y-5 pr-40">
                ...
                <div>
                    <Image  src="/Images/Homepage/gender.png" alt="gender" width={374} height={274}/>
                </div>
            </div>
        </section>
    );
