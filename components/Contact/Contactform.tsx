...
const Contactform =() => {
    ...
    return (
        <form onSubmit={handleSubmit} className="font-montserrat flex flex-col lg:flex-row gap-6 lg:w-9/12 lg:mx-auto md:px-36 px-5 py-10 md:pt-10 md:pb-20">
            <div className="py-6 md:mt-5 flex flex-col gap-8 font-montserrat text-[15px] font-normal ">
                <div className="flex flex-col gap-2">
                    <label htmlFor="Yourname" className="font-montserrat text-xs text-[#010101]">Your name</label>
                ...
                <div className="flex flex-col gap-2">
                    <label htmlFor="youremail" className="font-montserrat text-xs text-[#010101]">Your email</label>
                ...
                <div className="flex flex-col gap-2">
                    <label htmlFor="subject" className="font-montserrat text-xs text-[#010101]">Subject</label>
                ...
                <div className="flex flex-col gap-2">
                    <label htmlFor="message" className="font-montserrat text-xs text-[#010101]">Your message (optional)</label>
            ...
            <div className="pt-10">
                ...
                <div className="font-light items-center font-montserrat flex flex-row gap-1 py-4 ">
                    ...
                    <p className="text-xs font-normal text-[#010101]">9B Wuse Zone 4, Apartment 1A, Abuja Federal Capital Territory</p>
                </div>
                <hr className="border-b-2 my-2 mr-4" />
                <div className="text-xs items-center text-[#010101] font-normal font-montserrat flex flex-row gap-3 py-4 ">
