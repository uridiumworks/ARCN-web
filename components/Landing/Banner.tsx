...
const Bander = () => {
    return (
        <main className="md:h-auto banner bg-[#00000099] font-montserrat text-black">
            <div className="h-full bg-[#00000099] opacity-8">
                <div className="h-[80%] md:h-[100%] opacity-80 md:py-9 flex justify-center items-center">
                    <div className="w-full font-montserrat text-white space-y-5 text-center sm:py-4 px-4 md:px-0">
                ...
                <div className="h-[20%] md:h-[10%] font-montserrat bg-[#000000B2] flex flex-col md:flex-row justify-center items-center gap-8 md:gap-24 p-4 ">
                    ...
                    <div className="text-white text-center">
                        <h1 className="font-medium text-[24px] lg:text-[34.42px]">
                            Journal of Applied Agricultural <br />Research (JAAR)
                        </h1>
                        <p className="font-normal text-[16px] lg:text-[20.65px]">
                    ...
                    <div>
                        <button
                            type="button"
                            className="py-2 px-8 w-full md:w-[234.02px] font-montserrat h-[44.75px] font-Rubik rounded-sm font-bold text-base lg:text-[12.05px] text-white bg-[#04662A]"
                        >
                            SUBMIT NOW
                        </button>
                    </div>
