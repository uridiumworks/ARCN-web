      ...
      <div className="w-10/12 mx-auto pb-20 flex flex-col gap-10">
          ...
          {programs?.length > 0 && (
            <>
              {programs?.slice(0, 4)?.map((p: any, index: number) => (
                <div key={index} className="border py-2 px-3  grid grid-cols-2 gap-5 rounded-xl">
                  ...
                  <div className="flex flex-col items-end">
                    <Image
                      ...
                      width={201}
                      height={201}
                      className="rounded-md w-36 h-32"
                    />
                  </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          {programs?.length > 0 && (
            <>
              {programs?.slice(0, 4)?.map((p: any, index: number) => (
                <div key={index} className="border p-4 grid grid-cols-2 gap-5 rounded-xl">
